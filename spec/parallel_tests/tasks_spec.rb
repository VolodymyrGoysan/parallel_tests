...
describe ParallelTests::Tasks do
  describe ".parse_args" do
    ...
    it "should return the count, pattern, options, and exclude_pattern" do
      args = {:count => 2, :pattern => "plain", :options => "-p default", exclude_pattern: "some_pattern"}
      expect(ParallelTests::Tasks.parse_args(args)).to eq([2, "plain", "-p default", "some_pattern"])
    end
